...
consequence of \thmref{thm:abstraction}.
\begin{definition}
...
\defref{defn:valid-rel-env-family}. Therefore our non-definability
results are subject to the conditions in \thmref{thm:abstraction}.
