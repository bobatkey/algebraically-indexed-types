...
It will technically convenient to express substitution of index terms
in our framework in terms of simultaneous substitutions.  Given a pair
of index contexts $\Delta$ and $\Delta' = i_1 \mathord: s_1, ..., i_n
\mathord: s_n$, a \emph{simultaneous substitution} $\sigma : \Delta
