...
\textbf{FIXME:} talk about the standard way of separating the two
...
In our discussion in the previous section \textbf{?FIXME?}, we
...
% sort $\Transl(2)$ of translations. Translations form an abelian group,
