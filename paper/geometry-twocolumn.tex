...
\fixme{Need to make clear that the point is to make use of the
  algebraic indexing structure}
...
\begin{example}
  ...
  arbitrary translations \fixme{i.e. isometries}.
  \begin{displaymath}
    \begin{array}{@{}l}
  ...
  the type isomorphism we demonstrated above \fixme{ref}. We then
