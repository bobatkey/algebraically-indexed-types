...
%\begin{displaymath} \begin{array}{r@{\hspace{0.5em}:\hspace{0.5em}}l}
%  1 & \tyPrim{G}{1} \\ (\cdot) & \forall
%  a,b\mathord:\mathsf{G}.\ \tyPrim{G}{a} \to \tyPrim{G}{b} \to
%  \ty%Prim{G}{a\cdot b} \\ \ ^{-1} & \forall
%  a\mathord:\mathsf{G}.\ \tyPrim{G}{a} \to
%  \tyPrim{G}{a^{-1}} \end{array} \end{displaymath}
