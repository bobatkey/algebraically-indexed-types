...
\newcommand{\tySem}[1]{\lfloor #1 \rfloor}
\newcommand{\ctxtSem}[1]{\lfloor #1 \rfloor}
\newcommand{\tmSem}[1]{\lfloor #1 \rfloor}
\newcommand{\tyPrimSem}[1]{\lfloor #1 \rfloor}
...
\input{section-general-nondef.tex}
