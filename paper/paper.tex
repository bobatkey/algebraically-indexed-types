...
\newcommand{\SynTransl}{\mathsf{T}}
\newcommand{\SynGL}{\mathsf{GL}}
...
\newenvironment{example}{\smallskip\noindent\textbf{Example}}{\medskip} % FIXME: numbering, indentation?, box at the end?
...
%\input{section-motivating-examples.tex}
