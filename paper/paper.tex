...
\begin{abstract}
  ...
  that properties are invariant under are often organised into groups,
  the algebraic structure reflecting the composability and
  invertibility of transformations.
